...
export default function Page() {
  // Never pass jwtToken to ReactorProvider — we use connect(token) from the panel
  // so the provider never replaces the store mid-connect (which causes
  // "No active session" in effect cleanup).
